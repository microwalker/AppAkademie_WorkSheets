...
class GalleryItem {
  ...
  GalleryItem({required this.imageTitle, required this.imageDate, required this.imageDescription, required this.imagePath});
}
...
class PicItem {
  ...
  PicItem({required this.id, required this.author, required this.width, required this.height, required this.url, required this.downloadUrl});

  factory PicItem.fromMap(Map<String, dynamic> m) => PicItem(id: m["id"], author: m["author"], width: m["width"], height: m["height"], url: m["url"], downloadUrl: m["download_url"]);
}
