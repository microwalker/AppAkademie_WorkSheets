      ...
      body: Stack(fit: StackFit.expand, children: [
        ...
        Padding(padding: EdgeInsets.all(16), child: SingleChildScrollView(
          child: Column(spacing: 12, children: [ 
            ClipRRect(borderRadius: BorderRadius.all(Radius.circular(12)), child: InteractiveViewer(maxScale: 4, minScale: 0.5, scaleEnabled: true, panEnabled: true, child: Image.network(item.downloadUrl, semanticLabel: item.url))), 
