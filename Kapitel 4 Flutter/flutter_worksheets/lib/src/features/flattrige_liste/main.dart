...
void main() {
  runApp(const MaterialApp(home: FlattrigeListe()));
}
...
/// - Björg Schneider
/// 
class FlattrigeListe extends StatelessWidget {
  const FlattrigeListe({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Flattrige Liste"),),
